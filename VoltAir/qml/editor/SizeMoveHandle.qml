...
Rectangle {
    ...
    property QtObject targetItem:parent
        ...
        MouseArea {
            ...
            onPositionChanged: {
                if(resize) {
                    ...
                    targetItem.height = targetItem.height+diff;
                    targetItem.y = targetItem.y - diff;
                    courserPos = mouseY;
                }
        ...
        MouseArea {
            ...
            onPositionChanged: {
                if(resize) {
                    ...
                    targetItem.width = targetItem.width-diff;
                    courserPos = mouseX;
                }
        ...
        MouseArea {
            ...
            onPositionChanged: {
                if(resize) {
                    ...
                    targetItem.width = targetItem.width+diff;
                    targetItem.x = targetItem.x - diff;
                    courserPos = mouseX;
                }
