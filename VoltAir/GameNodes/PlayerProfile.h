...
class PlayerProfile : public QObject {
    ...
    /**
    * @brief A way of handling the availability of profile stuff.
    */
    Q_PROPERTY(bool enabledProfile READ getEnabledProfile WRITE setEnabledProfile NOTIFY enabledProfileChanged)
public:
    /**
    ...
    * @brief
    */
    bool getEnabledProfile() const{ return mEnabledProfile;}
    /**
    * @brief
    */
    void setEnabledProfile(const bool enabled);
...
signals:
    ...
    void newDataMerged();
    /**
    * @brief Emittend when the #enabledProfile changes.
    */
    void enabledProfileChanged();
