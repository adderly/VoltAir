...
void UiInternal::setPassMouseToInputArea(const bool value){
    mPassMouseToInputArea = value;
...
bool UiInternal::childMouseEventFilter(QQuickItem *item, QEvent *event)
{
    switch(event->type()){
...
void UiInternal::mousePressEvent(QMouseEvent *event)
{
    QQuickItem::mousePressEvent(event);
}

void UiInternal::mouseMoveEvent(QMouseEvent *event)
{
    QQuickItem::mousePressEvent(event);
}

void UiInternal::mouseReleaseEvent(QMouseEvent *event)
{
    QQuickItem::mousePressEvent(event);
}
