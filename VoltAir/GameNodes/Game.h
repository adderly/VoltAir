 ...
 * TODO:
 *  - add startup method that should be implemented by avery game.
 *  - Remove Voltair specific score variables and conditions.
 */
...
public:
    ...
    /**
    *  @brief Use this instead of init to initialize engine related
    * implementations.Leave init to user code.
    *
    */
    //virtual void startUp(){}

    /**
    *   @brief Set the location of the UI for the game.
    */
    void setUiPath(QString path){ m_ui_path = path;}

    /**
    *   @brief Returns the location of the path to the UI.
    */
    QString getUiPath() const {return m_ui_path;}

    /**
    * @brief Set the input manager.
    * Note: This most be set before, Game::init.
    * TODO: fix the initialization thing,
    * this is mostly for costumization purposes.
    */
    void setInputManager(InputManager* iManager);

    /**
    * @brief Return the InputManager.
    */
    InputManager* getInputManager() const { return mInputManager; }

    /**
    *   @brief set the progression level path.
    */
    void setProgressionLevelPath(QString path){ m_progression_level_path =path;}

    /**
    *   @brief returns the path to the progression level.
    */
    QString getProgressionLevelPath()const {return m_progression_level_path;}
    ...
    */
    ...
    /**
    *   @brief This are used for collision filtering with box2d.
    */
    static unsigned int PLAYER_CATEGORY_BITS;
    static unsigned int ENEMY_CATEGORY_BITS;
...
private:
    ...
    QString m_ui_path = "qml/Ui.qml";
    //Should be customizable.
    QString m_progression_level_path = "qml/VoltAirLevelProgressionList.qml";
