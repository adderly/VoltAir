...
class UiInternal : public QQuickItem {
     ...
     * is showing.
     */
    Q_PROPERTY(bool passMouseToInputArea READ passMouseToInputArea WRITE setPassMouseToInputArea
            NOTIFY mouseToInputAreaChanged)
public:
    /**
     ...
     * @brief .
     */
    void setPassMouseToInputArea(const bool value);

    /**
     * @brief .
     */
    bool passMouseToInputArea()const { return mPassMouseToInputArea; }
...
signals:
    ...
    /**
     * @brief Emitted when the Ui can pass mouse events to the InputArea.
     */
    void mouseToInputAreaChanged();
protected:
    /**
     * @brief Used to pass the mouse input to the InputArea if enabled.
     */
...
private:
    ...
    bool mPassMouseToInputArea = false;
