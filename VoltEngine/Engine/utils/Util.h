...
/**
 * @brief Returns the entire contents of a text file as a @c QByteArray.
 * @param path Path to file to read
*/
QByteArray readFileAsBytes(QString& filename);
...
/**
*   @brief Checks if the javascript method exists then executes it.
*/
void javaScriptExecuteFuncIfExists(QObject* object, const char* method);

/**
 *  Check if the string is null or empty.
 */
bool nullOrEmpty(const QString& st);

/**
* Find the name of the file based in the url.
* And if exists, it will add a number to differentiate it.
*/
QString fileName(QString dirpath,QUrl url);
...
/**
*   @brief retuns the bounding box of a body.
*/
b2AABB getBodyBoundingBox(b2Body* body);
