...
class Body : public QObject {
    ...
    *   @brief
    */
    Q_PROPERTY(unsigned int categoryBits READ getCategoryBits WRITE setCategoryBits )

    /**
    *   @brief
    */
    Q_PROPERTY(unsigned int maskBits READ getMaskBits WRITE setMaskBits )

    /**
    *   @brief
    */
    Q_PROPERTY( int groupIndex READ getGroupIndex WRITE setGroupIndex )

    /**
    *   @brief
    */
    Q_PROPERTY(float initialX READ initialX WRITE setInitialX  NOTIFY initialXChanged)

    /**
    *   @brief
    */
    Q_PROPERTY(float initialY READ initialY WRITE setInitialY NOTIFY initialYChanged)
    ...
    */
     ...
     * @brief The restitution value for all of this Body's @c b2Fixture%s.
     */
    Q_PROPERTY(bool manualInitialization READ manualInitialization WRITE setManualInitialization NOTIFY manualInitializationChanged)
...
public:
    ...
    /**
    * @brief Used for construction.
    */
    Body(b2Body* body,bool manualInit = true,QObject* parent = nullptr);
    ...
    /**
    * @brief Used when the #manualInitialization is set.
    * Note: This is usefull in cases where the physics are customized.
    * E.X: Loading a different world, before level complete.
    */
    void initBody();

    /**
    * @brief Used when the #manualInitialization is set. Passing
    *        the bodyDefinition for creation.
    */
    b2Body* initBody(b2BodyDef bodyDef);

    /**
    *   @brief Sets the #initialX variable.
    */
    void setInitialX(float x);

    /**
    *   @brief Returns the #initialX variable.
    */
    float initialX() {  return mInitialX;  }

    /**
    *   @brief  Sets the #initialY variable.
    */
    void setInitialY(float y);

    /**
    *   @brief Returns the #initialY variable.
    */
    ...
    */
    unsigned short getMaskBits() {  return mMaskBits;  }

    /**
    *   @brief Sets the maskBits for box2d collision.
    *   @note This is usefull only when creating objects manually.
    */
    void setMaskBits(unsigned short bits );

    /**
    *   @brief Return #categoryBits.
    */
    unsigned short getCategoryBits() {  return mCategoryBits;  }

    /**
    *   @brief Sets the categoryBits for box2d collision.
    *   @note This is usefull only when creating objects manually.
    */
    void setCategoryBits(unsigned short bits);

    /**
    *   @brief Return #groupIndex.
    */
     int getGroupIndex() {  return mGroupIndex;  }

    /**
    *   @brief Sets the groupIndex for filtering box2d collision.
    *   @note This is usefull for managing which object collide.
    */
    ...
    */
    ...
    /**
    *   @brief Returns the property #bullet from the b2body.
    */
    bool getIsBullet();
    ...
    *   @brief
    */
    Q_INVOKABLE void applyLinearImpulse(const QPointF& impulse, const QPointF& point, bool wake);
    ...
    /**
     * @brief Set the #ManualInitialization.
     */
    void setManualInitialization(bool value);
     ...
     */
    void setCreatedFromB2Body(bool value) { mCreatedFromB2Body = value; }

    /**
     * @brief Returns created from b2body.
     */
    bool createdFromB2Body() { return mCreatedFromB2Body; }
    ...
    /**
    *   @brief Checks if the body is colliding with the #other body.
    */
    bool isCollidingWithBody(Body* other);
    ...
    /**
    *   @brief Used to return the properties for the body.
    */
...
signals:
    ...
    */
    ...
    /**
     * @brief Emitted when #ManualInitizalization changes.
     */
    void manualInitializationChanged();
...
private:
    ...
    float mInitialX = -1000.0f;
    float mInitialY = -1000.0f;
