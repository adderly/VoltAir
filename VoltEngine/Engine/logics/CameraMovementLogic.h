...
public:
    ...
    *  @brief
    */
    void setViewportChanged(bool value);
    /**
...
public slots:
    ...
    void mouseWheel(QPoint pixelDelta,QPoint angleDelta);

    void mouseMoved(QPoint pos,QPoint delta);
...
private:
    ...
    void zoomCamera(QPoint zoomLevel) const;
