...
QMap<int, JoystickAxisCode> AndroidActivity::sGamepadJoystickAxisConversionMap({
            { D_AXIS_X, LEFT_ANALOG_X },
            { D_AXIS_Y, LEFT_ANALOG_Y },
            { D_AXIS_Z, RIGHT_ANALOG_X },
            { D_AXIS_RZ, RIGHT_ANALOG_Y },
        });
QMap<int, TriggerAxisCode> AndroidActivity::sGamepadTriggerAxisConversionMap({
            { AXIS_LTRIGGER, LEFT_TRIGGER },
            { AXIS_RTRIGGER, RIGHT_TRIGGER },
            { AXIS_BRAKE, LEFT_TRIGGER },
            { AXIS_GAS, RIGHT_TRIGGER },
        });
QMap<int, JoystickAxisCode> AndroidActivity::sTouchNavigationJoystickAxisConversionMap({
            { D_AXIS_X, TOUCH_NAVIGATION_X },
            { D_AXIS_Y, TOUCH_NAVIGATION_Y },
        });
...
bool AndroidActivity::onGamepadMotionEvent(JNIEnv* jni, jobject, jobject motionEvent) {
    ...
    float dpadX = getAxisValue(jni, motionEvent, D_AXIS_X);
    float dpadY = getAxisValue(jni, motionEvent, D_AXIS_Y);
