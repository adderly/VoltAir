...
class Logic : public QObject {
    ...
    /**
     * @brief Property holding the name of the logic, used when handling logic with manager.
     */
...
public:
    ...
    /**
    * @brief Sets #name.
    * @param value the Name of the logic.
    * @note Used to identified in case on managed.
    */
    void setName(QString name);

    /**
     * @brief return  the #name of the logic.
     */
    QString getName() { return mName; }

    /**
    *   @brief Gets the #aAIManaged.
    *   @note This means the logic will be updated from somewhere else
    *   but directly from the engine loop.
    */
    bool isManaged() { return mAIManaged;  }
